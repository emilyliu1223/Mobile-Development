...
import 'package:sportsmate/NewItemPage.dart';
...
class PlaceDetailWidget extends StatefulWidget {
  ...
  final String userId;
  final String title;
  PlaceDetailWidget({Key key,this.auth, this.userId, this.logoutCallback,this.placeId, this.title}):super(key: key);
  @override
                          ...
                          FlatButton(
                            ...
                            {Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) =>
                                  NewItemPage(
                                      location: placeDetail.formattedAddress,
